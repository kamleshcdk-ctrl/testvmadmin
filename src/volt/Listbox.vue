...
const theme = ref<ListboxPassThroughOptions>({
    ...
    option: `
        flex items-center cursor-pointer relative overflow-hidden px-3 py-2 border-none rounded-sm
        text-surface-700 dark:text-surface-0
        hover:not-p-selected:bg-surface-100 dark:hover:not-p-selected:bg-primary-800 hover:not-p-selected:text-surface-800 dark:hover:not-p-selected:text-surface-0
