...
const theme = ref<SelectPassThroughOptions>({
    ...
    option: `cursor-pointer font-normal whitespace-nowrap relative overflow-hidden flex items-center
      ...
      p-focus:bg-surface-100 dark:p-focus:bg-surface-800 p-focus:text-surface-500 dark:p-focus:text-surface-0
      p-selected:bg-highlight p-focus:p-selected:bg-highlight-emphasis p-focus:p-selected:text-surface-500 p-selected:text-surface-500
      transition-colors duration-200`,
